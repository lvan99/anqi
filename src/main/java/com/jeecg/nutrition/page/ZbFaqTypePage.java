 ...
 *
 */
public class ZbFaqTypePage implements java.io.Serializable {
	/**主键*/
	...
	/**保存-常见问题详情*/
    @ExcelCollection(name="常见问题详情")
	private List<ZbFaqEntity> zbFaqList = new ArrayList<ZbFaqEntity>();
		public List<ZbFaqEntity> getZbFaqList() {
		return zbFaqList;
		}
		public void setZbFaqList(List<ZbFaqEntity> zbFaqList) {
		this.zbFaqList = zbFaqList;
		}
}
