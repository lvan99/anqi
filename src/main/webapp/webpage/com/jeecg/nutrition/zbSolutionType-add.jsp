...
<head>
 ...
 <body>
  <form id="formobj" action="zbSolutionTypeController.do?doAdd" name="formobj" method="post">
...
<div id="jform_tab" class="tab-wrapper">
	<!-- tab -->
    <ul class="nav nav-tabs">
		    	<li role="presentation" tab-ajax-url="zbSolutionTypeController.do?zbSolutionList&pK_SOLUTION_TYPE=${zbSolutionTypePage.pK_SOLUTION_TYPE}"><a href="#con-wrapper0">解决方案详情</a></li>
    </ul>
