...
<head>
 ...
 <body>
  <form id="formobj" action="zbProductTypeMainController.do?doAdd" name="formobj" method="post">
			...
			<div class="tab-wrapper">
			    ...
			    <div class="con-wrapper" style="display: block;">
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3">
								<input id="mainTypeName" name="mainTypeName" type="text" class="form-control"  >
