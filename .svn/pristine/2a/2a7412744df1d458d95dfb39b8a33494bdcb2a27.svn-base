 ...
 */
@Entity
@Table(name = "zb_product_type_h", schema = "")
@SuppressWarnings("serial")
public class ZbProductTypeHEntity implements java.io.Serializable {
	/**主键*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  主分类
	 */
	@Column(name ="MAIN_TYPE",nullable=true,length=100)
